...
# Execute the cloud environment initialization check
...
if st.sidebar.button("Analyze & Add to Watchlist"):
    ...
    st.session_state.watchlist = load_saved_watchlist()  # Sync current session state
    st.rerun()
...
if st.sidebar.button("Clear All Saved Data"):
    ...
    initialize_cloud_storage()  # Recreate empty structures cleanly
    st.rerun()
